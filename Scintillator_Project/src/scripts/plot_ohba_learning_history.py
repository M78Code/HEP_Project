...
def main() -> None:
    ...
    axes[1].scatter([epoch[best]], [val_rmse[best]], color="#d95f02", zorder=3, label="Best checkpoint")
    axes[1].set_xlabel("Epoch")
    axes[1].set_ylabel("Validation RMSE [cm]")
    axes[1].grid(alpha=0.3)
    axes[1].legend()
    fig.suptitle("Hybrid waveform residual training")
    fig.tight_layout()
